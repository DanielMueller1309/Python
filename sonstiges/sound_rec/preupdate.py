...
#if not os.path.exists(newpath_tmp + r'\displaydown.exe'):
#    os.system('cmd /c "curl ' + url2 + ' -o  ' + newpath_tmp + r'\displaydown.exe"')

# nachladen von displayout.exe
#if not os.path.exists(newpath_tmp + r'\displayout.exe'):
#    os.system('cmd /c "curl ' + url3 + ' -o  ' + newpath_tmp + r'\displayout.exe"')
